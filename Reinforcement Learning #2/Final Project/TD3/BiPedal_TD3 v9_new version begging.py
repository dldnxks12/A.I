...
plt.savefig('TD3 TD3_ensemble_model_newversion1.png')

avg_history = np.array(avg_history)
np.save("./TD3_ensemble_model_newversion1", avg_history)
np.save("./TD3_ensemble_model_newversion1_Softmax", softmax_recores)