...
while episode < MAX_EPISODES:
    ...
    while not done:
        ...
        action_list = [action1 + noise1, action2 + noise2, action3 + noise3, action4 + noise4]
...
with open('exploration-v1_noise.txt', 'w', encoding='UTF-8') as f:
    f.write("# ----------------------- # " + '\n')
...
plt.xlabel("Episode")
plt.ylabel("Reward")
plt.title("exploration-v1_noise")
plt.plot(length, reward_history_20)
plt.savefig('exploration-v1_noise.png')