...
###########################################################################
# Train ...
def train(mu1,mu2,mu3, mu_target1,mu_target2,mu_target3, q, q_target, memory, q_optimizer, mu_optimizer1, mu_optimizer2, mu_optimizer3):
...
while episode < MAX_EPISODES:
    ...
    if memory.size() > 2000:
        for _ in range(10):
            ...
            train(mu1,mu2,mu3, mu_target1,mu_target2,mu_target3, q, q_target, memory, q_optimizer, mu_optimizer1, mu_optimizer2, mu_optimizer3)
...
with open('test 2.txt', 'w', encoding = 'UTF-8') as f:
    f.write("# ----------------------- # " + '\n')
