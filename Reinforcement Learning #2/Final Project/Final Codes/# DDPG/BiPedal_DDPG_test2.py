...
while episode < MAX_EPISODES:
    ...
    while not done:
        ...
        if memory.size() > 2000:
            for i in range(5):
                train(mu1, mu_target1, q1, q_target1, memory, q_optimizer1, mu_optimizer1, batch_size=16)
                train(mu2, mu_target2, q1, q_target1, memory, q_optimizer1, mu_optimizer2, batch_size=16)
                train(mu3, mu_target3, q1, q_target1, memory, q_optimizer1, mu_optimizer3, batch_size=16)
                train(mu4, mu_target4, q1, q_target1, memory, q_optimizer1, mu_optimizer4, batch_size=16)
