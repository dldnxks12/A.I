...
q_optimizer1 = optim.Adam(q1.parameters(), lr=0.01)
q_optimizer2 = optim.Adam(q2.parameters(), lr=0.05)
q_optimizer3 = optim.Adam(q3.parameters(), lr=0.1)
q_optimizer4 = optim.Adam(q4.parameters(), lr=0.5)
...
mu_optimizer1 = optim.Adam(mu1.parameters(), lr = 0.05)
mu_optimizer2 = optim.Adam(mu2.parameters(), lr = 0.5)
mu_optimizer3 = optim.Adam(mu3.parameters(), lr = 0.01)
mu_optimizer4 = optim.Adam(mu4.parameters(), lr = 0.1)
...
plt.savefig('Another Model 2.png')