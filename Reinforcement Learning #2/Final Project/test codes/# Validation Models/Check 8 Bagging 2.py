...
mu_target6.load_state_dict(mu4.state_dict()) # 파라미터 동기화
...
while episode < MAX_EPISODES:
    ...
    if memory.size() > 5000:
        ...
        train(mu6, mu_target6, q, q_target, memory, q_optimizer, mu_optimizer6)
...
with open('Check 8.txt', 'w', encoding = 'UTF-8') as f:
    f.write("# ----------------------- # " + '\n')
