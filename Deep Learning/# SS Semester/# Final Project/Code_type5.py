...
# Type 2에서는 Node 개수가 다른 Actor를 8개 사용합니다.
...
class MuNet3(nn.Module):
    def __init__(self):
        super(MuNet3, self).__init__()
        self.fc1 = nn.Linear(24, 256)
        self.fc2 = nn.Linear(256, 256)
        self.fc_mu = nn.Linear(256, 4)
...
class MuNet5(nn.Module):
    def __init__(self):
        super(MuNet5, self).__init__()
        self.fc1 = nn.Linear(24, 192)
        self.fc2 = nn.Linear(192, 192)
        self.fc_mu = nn.Linear(192, 4)
...
np.save("./type5", avg_history)
np.save("./Softmax type5", softmax_recores)
