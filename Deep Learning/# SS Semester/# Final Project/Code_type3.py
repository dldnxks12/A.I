...
mu_optimizer5 = optim.Adam(mu5.parameters(), lr=0.09)
mu_optimizer6 = optim.Adam(mu6.parameters(), lr=0.05)
mu_optimizer7 = optim.Adam(mu7.parameters(), lr=0.03)
mu_optimizer8 = optim.Adam(mu8.parameters(), lr=0.01)
