...
HEIGHT = 5  # 그리드월드 세로
WIDTH = 5  # 그리드월드 가로
TRANSITION_PROB = 1 # State Transition Probability --- DP는 이 정보가 필요
...
class Env:
    def __init__(self):
        ...
        self.width = WIDTH
        self.height = HEIGHT
        self.reward = [[0] * WIDTH for _ in range(HEIGHT)] # Reward 2차원 배열로 생성 --- 우리가 원하는 곳에 reward 배치할 것
    ...
    def check_boundary(state):
        ...
        # 열의 위, 아래 경계에서 바깥으로 나가는 행동을 하면 제자리로 돌아오도록.
