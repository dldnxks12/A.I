	...
	while True:		
		...
		if Init_angle == False:				
			...
			if (No_left_line_flag == 0) and (No_right_line_flag == 0) and (Left_Avg_points_temp != 0) and (Right_Avg_points_temp != 0):							
				#Lx1, Ly1, Lx2, Ly2  = Left_Avg_points_temp   
				#Rx1, Ry1, Rx2, Ry2  = Right_Avg_points_temp  

				#STM_Left_Dist  = cal_dist(Lx1, Ly1, Lx2, Ly2, canvas_width //2, canvas_height)
				#STM_Right_Dist = cal_dist(Rx1, Ry1, Rx2, Ry2, canvas_width //2, canvas_height)
				STM_Left_Dist  = Left_Avg_Pos
				STM_Right_Dist = Right_Avg_Pos
			...
			if (No_left_line_flag == 1) and (No_right_line_flag == 0)  and (Right_Avg_points_temp != 0):			
				...
				#STM_Right_Dist 	= cal_dist(Rx1, Ry1, Rx2, Ry2, height //2, width)
				STM_Right_Dist 	= Right_Avg_Pos
			...
			if (No_left_line_flag == 0) and (No_right_line_flag == 1) and (Left_Avg_points_temp != 0):			
				...
				#STM_Left_Dist 	= cal_dist(Lx1, Ly1, Lx2, Ly2, height //2, width)
				STM_Left_Dist 	= Left_Avg_Pos
