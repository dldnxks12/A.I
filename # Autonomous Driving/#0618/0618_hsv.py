...
try:
	while True:		
		...
		vertices = np.array([[(0,height),(width//2-200, height//2 ), (width//2+200, height//2), (width,height)]], dtype=np.int32)  		
		...
		# ------------------------ Initialize distance ---------------------- #	
		if (lines is not None) and (Init_angle == False) and (Init_distance == True): 			
			print(" # --- Init distance --- # ")
			No_line_flag = 0 			
