...
tfidf_fit1 = tfidf_vect.fit(data['body_text'])
X_tfidf = tfidf_fit1.transform(data['body_text'])
...
pickle.dump(tfidf_fit1, open('saved_models/nv_tfidf.pkl', 'wb'))
pickle.dump(nv, open('saved_models/nv_trained.pkl', 'wb'))
